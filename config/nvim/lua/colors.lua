...
vim.cmd [[
  ...
  highlight CmpItemAbbr guifg=#008d00
  highlight CmpItemAbbrDeprecated guifg=#666666
  highlight CmpItemAbbrMatch guifg=darkcyan
  highlight CmpItemKind guifg=magenta
  ...
  highlight @lsp.type.typeParameter guifg=#ffbbb8
