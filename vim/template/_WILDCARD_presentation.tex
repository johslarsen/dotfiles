...
\title%[compressed title]
{#TITLE#}
\subtitle{#SUBTITLE#}

\def\authormail{mail@johslarsen.net}
...
{#=strftime("\%Y-\%m")#-#DATE#} % maybe include conference,...

\subject{#SUBJECT#} % only in pdf metadata
